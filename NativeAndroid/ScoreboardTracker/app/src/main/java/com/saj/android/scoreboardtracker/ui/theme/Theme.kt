package com.saj.android.scoreboardtracker.ui.theme
...
private val LightColorPalette = ScoreboardColors(
    brand = Shadow5,
...
private val DarkColorPalette = ScoreboardColors(
    brand = Shadow1,
...
fun ScoreboardTheme(
    ...
    ProvideScoreboardColors(colors) {
        MaterialTheme(
...
object ScoreboardTheme {
    val colors: ScoreboardColors
        @Composable
        get() = LocalScoreboardColors.current
}
...
class ScoreboardColors(
    ...
    fun update(other: ScoreboardColors) {
...
private val LocalScoreboardColors = staticCompositionLocalOf<ScoreboardColors> {
    error("No ScoreboardColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [ScoreboardTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
